...
camera_tilt = 18 # degrees downward (measured for AIM-BA8D7D18)
...
class AIMKinematics(Kinematics):
    ...
    display_height = robot_height # mm (center of display above base origin)
    wheel_center_radius = body_diameter / 2  # mm
    wheel_center_height = 14  # mm (approx wheel axle height above ground)
