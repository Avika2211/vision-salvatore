...
from .worldmap import WorldObject, BarrelObj, SportsBallObj, AprilTagObj, DoorwayObj, ArucoMarkerObj, RoomObj, DominoObj
...
class PathPlanner():
    ...
    def setup_problem(goal_object, robot, use_doorways):
        ...
        elif isinstance(goal_object, DominoObj):
            goal_shape = RRT.generate_domino_obstacle(goal_object, 0)
